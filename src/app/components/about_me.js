    ...
    <section id="about" className={styles.sectionAbout}>
      <div className={styles.maxWidth}>
        ...
        <div className={styles.cardContainer}>
            <p className="mb-4">
                I am currently a Developer at <span className={styles.highlightText}>ExxonMobil</span>, with a solid academic background from <span className={styles.highlightText}>Eotvos Lorand University</span> where I specialized in web development, data science, and AI. My journey includes numerous certifications and a dedication to practical applications, as evidenced by my work on enhancing server efficiency through automation tools. You can download my CV from <a href="/Naz CV.pdf" download className={styles.link}>here</a>.              
            </p>
