    ...
    <section id="about" className={styles.sectionAbout}>
      <div className={styles.maxWidth}>
        ...
        <div className={styles.cardContainer}>
            <p className="mb-4">
                I am currently a Developer at <span className={styles.highlightText}>ExxonMobil</span>. At the same time, I am undertaking a part-time Master's in Software Engineering at <span className={styles.highlightText}>Italy</span>. You can download my CV from <a href="/Naz CV.pdf" download="Naz_CV.pdf" className={styles.link}>here</a>.              
            </p>
